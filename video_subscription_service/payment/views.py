...
from video_subscription_service.content.models import Pricing
...
def webhook(request):
    ...
    # print data object to see what values to access
...
class PaymentView(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update(
            {"pricing_tier": pricing, "STRIPE_PUBLIC_KEY": settings.STRIPE_PUBLIC_KEY}
        )
        return context


class CreateSubscriptionView(LoginRequiredMixin, APIView):
